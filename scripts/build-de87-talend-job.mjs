...
const SF_CONN_BLOCK_FILE = "C:/Users/alejandro.salas/Documents/ASO/JanusAI/janus-ia/dump/uploads/snowflake-conn-block.xml";
...
${colsToMetadataXml("FLOW", "tFileOutputDelimited_1")}
  ...
  <node componentName="tFTPPut" componentVersion="0.103" offsetLabelX="0" offsetLabelY="0" posX="600" posY="240">
    <elementParameter field="TEXT" name="UNIQUE_NAME" value="tFTPPut_1" show="false"/>
    <elementParameter field="CHECK" name="USE_EXISTING_CONNECTION" value="false"/>
    <elementParameter field="COMPONENT_LIST" name="CONNECTION" value=""/>
    <elementParameter field="TEXT" name="HOST" value="context.pfx_sftp_host"/>
    <elementParameter field="TEXT" name="PORT" value="context.pfx_sftp_port"/>
    <elementParameter field="TEXT" name="USERNAME" value="context.pfx_sftp_user"/>
    <elementParameter field="PASSWORD" name="PWD" value="context.pfx_sftp_password"/>
    <elementParameter field="CHECK" name="USE_SFTP" value="true"/>
    <elementParameter field="CHECK" name="USE_FTPS" value="false"/>
    <elementParameter field="CLOSED_LIST" name="AUTH_METHOD" value="Password"/>
    <elementParameter field="FILE" name="KEYFILE" value="&quot;&quot;" show="false"/>
    <elementParameter field="PASSWORD" name="KEY_PASSPHRASE" value="" show="false"/>
    <elementParameter field="DIRECTORY" name="REMOTEDIR" value="context.pfx_sftp_remote_dir"/>
    <elementParameter field="DIRECTORY" name="LOCALDIR" value="context.local_csv_dir"/>
    <elementParameter field="CLOSED_LIST" name="TRANSFER_MODE" value="binary"/>
    <elementParameter field="CHECK" name="MOVE_TO_THE_CURRENT_DIR" value="false"/>
    <elementParameter field="CHECK" name="OVERWRITE_FILE" value="true"/>
    <elementParameter field="CHECK" name="KEEP_ORIGINAL_FILE_NAME" value="true"/>
    <elementParameter field="TABLE" name="FILES">
      <elementValue elementRef="FILEMASK" value="context.csv_filename"/>
      <elementValue elementRef="NEWNAME" value="&quot;&quot;"/>
    </elementParameter>
    <elementParameter field="CHECK" name="DIE_ON_ERROR" value="true"/>
    <elementParameter field="ENCODING_TYPE" name="ENCODING" value="&quot;UTF-8&quot;" show="false"/>
    <elementParameter field="TEXT" name="LABEL" value="Push to Pricefx SFTP"/>
    <elementParameter field="TEXT" name="CONNECTION_FORMAT" value="row"/>
  </node>
  <node componentName="tJava" componentVersion="0.101" offsetLabelX="0" offsetLabelY="0" posX="800" posY="240">
    <elementParameter field="TEXT" name="UNIQUE_NAME" value="tJava_PostWrite" show="false"/>
    <elementParameter field="MEMO_JAVA" name="CODE" value="Integer rows = (Integer)globalMap.get(&quot;tFileOutputDelimited_1_NB_LINE&quot;);&#xA;Integer files = (Integer)globalMap.get(&quot;tFTPPut_1_NB_FILE&quot;);&#xA;System.out.println(&quot;[DE-87] wrote &quot; + rows + &quot; rows to &quot; + context.local_csv_dir + &quot;/&quot; + context.csv_filename + &quot; | uploaded &quot; + files + &quot; file(s) to &quot; + context.pfx_sftp_host + &quot;:&quot; + context.pfx_sftp_remote_dir);&#xA;"/>
    <elementParameter field="MEMO_IMPORT" name="IMPORT" value=""/>
    <elementParameter field="TEXT" name="LABEL" value="Log row+upload"/>
    <elementParameter field="TEXT" name="CONNECTION_FORMAT" value="row"/>
  ...
  <connection connectorName="COMPONENT_OK" label="OnComponentOk" lineStyle="3" metaname="tFileOutputDelimited_1" offsetLabelX="0" offsetLabelY="0" source="tFileOutputDelimited_1" target="tFTPPut_1">
    <elementParameter field="TEXT" name="UNIQUE_NAME" value="OnComponentOk3" show="false"/>
  </connection>
  <connection connectorName="COMPONENT_OK" label="OnComponentOk" lineStyle="3" metaname="tFTPPut_1" offsetLabelX="0" offsetLabelY="0" source="tFTPPut_1" target="tJava_PostWrite">
    <elementParameter field="TEXT" name="UNIQUE_NAME" value="OnComponentOk5" show="false"/>
  </connection>
