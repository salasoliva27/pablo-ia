...
### Responsibility
Keep Pablo informed on how all projects are performing without requiring him to manually check each one. Surface the right information at the right time.

### Individual project metrics
Each project tracks what's relevant to its type.

_(Populated per product as they are spun up. Template:)_

**[project-name]:** (metrics list)
...
- Next action required from Pablo per project
...
3. Present to Pablo at the start of the session
...
- A client goes silent for more than 7 days
